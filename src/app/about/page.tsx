      ...
      <div className="max-w-7xl mx-auto">
        ...
        <section className="grid lg:grid-cols-2 gap-16 items-center mb-32">
          ...
          >
             ...
             <p className="text-lg text-muted-foreground leading-relaxed mb-6">
                Born in the heart of Meiran, Alimosho, grillsJunction isn't just a restaurant—it's a tribute to the nocturnal soul of Lagos. We believe that premium barbecue shouldn't be reserved for high-end lounges alone.
             </p>
             <p className="text-lg text-muted-foreground leading-relaxed">
                Founded in 2021 by a visionary team determined to redefine the street-food culture of Lagos, our mission was simple: 100% authentic flavors, served with 100% luxury vibes.
             </p>
          </motion.div>
        ...
        <section className="glass rounded-[4rem] p-12 md:p-24 mb-32 relative overflow-hidden">
           ...
           <div className="max-w-4xl mx-auto text-center relative z-10">
              ...
              <p className="text-xl text-muted-foreground leading-relaxed">
                 We are breaking barriers in the traditionally male-dominated world of Lagos pit-masters. Every spice blend is crafted with care, and every member of our team is family. When you eat at grillsJunction, you're supporting local Lagos craftsmanship.
              </p>
           </div>
        </section>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-32">
           {[
             ...
             <div key={i} className="glass-card p-10 rounded-[3rem] border-border hover:border-primary/20 transition-colors">
                <div className="w-14 h-14 bg-muted rounded-2xl flex items-center justify-center mb-6 text-primary">
        ...
        <section className="mb-32">
           <div className="text-center mb-16">
              <h2 className="text-4xl md:text-6xl font-headline font-bold">
                The <span className="font-body not-italic">grillsJunction</span> Vibe
              </h2>
           </div>
