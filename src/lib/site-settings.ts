...
export const defaultSiteSettings: SiteSettings = {
  ...
  siteDescription: "Savor the rich flavors of our signature Asun, perfectly grilled Chicken, spicy croaker fish, and other mouthwatering specialties. Prepared fresh, served hot, and crafted with passion because every meal should be memorable.",
